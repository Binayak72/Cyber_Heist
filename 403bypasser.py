...
print(Fore.BLUE + Style.BRIGHT + custom_fig.renderText('Cyber Heist') + Style.RESET_ALL)
print(Fore.GREEN + Style.BRIGHT + "____________________ Team Web Wizards ____________________\n")
print(Fore.LIGHTMAGENTA_EX + Style.BRIGHT + "-----> Twitter   : https://twitter.com/BinayakMahato2\n")
print(Fore.MAGENTA + Style.BRIGHT + "-----> GitHub    : https://github.com/Binayak72\n")
print(Fore.MAGENTA + Style.BRIGHT + "-----> LinkedIn  : https://www.linkedin.com/in/binayak-kumar-mahato/\n")
print(Fore.BLUE + Style.BRIGHT + custom_fig.renderText('-------------') + Style.RESET_ALL)
# DISPLAY BANNER -- END
